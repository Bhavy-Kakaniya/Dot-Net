...
namespace StudentProjectManagementSystem.Controllers
{
   ...
   public class UserRoleController : ControllerBase
   {
       ...
       public async Task<ActionResult<ApiResponse<IEnumerable<UserRoleResponseDto>>>> GetAllUserRoles()
       {
           ...
           return Ok(
               ApiResponse<IEnumerable<UserRoleResponseDto>>.SuccessResponse(
       ...
       public async Task<ActionResult<ApiResponse<UserRoleResponseDto>>> GetUserRoleById(int id)
       {
           ...
           {
               return NotFound(
                   ApiResponse<UserRoleResponseDto>.ErrorResponse(
           ...
           return Ok(
               ApiResponse<UserRoleResponseDto>.SuccessResponse(
       ...
       [HttpPost]
       public async Task<ActionResult<ApiResponse<UserRoleResponseDto>>> CreateUserRole(
