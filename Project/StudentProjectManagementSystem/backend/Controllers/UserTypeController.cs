...
namespace StudentProjectManagementSystem.Controllers
{
    ...
    public class UserTypeController : ControllerBase
    {
        ...
        public async Task<ActionResult<ApiResponse<IEnumerable<UserTypeResponseDto>>>> GetAllUserTypes()
        {
            ...
            return Ok(
                ApiResponse<IEnumerable<UserTypeResponseDto>>.SuccessResponse(
        ...
        public async Task<ActionResult<ApiResponse<UserTypeResponseDto>>> GetUserTypeById(int id)
        {
            ...
            {
                return NotFound(
                    ApiResponse<UserTypeResponseDto>.ErrorResponse(
                        $"UserType with {id} not found"
                    )
                );
            }
            ...
            return Ok(
                ApiResponse<UserTypeResponseDto>.SuccessResponse(
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResponse<UserTypeResponseDto>>> CreateUserType(
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<ApiResponse<UserTypeResponseDto>>> UpdateUserType(
            int id,
