...
namespace StudentProjectManagementSystem.Controllers
{
    ...
    public class ProjectTaskController : ControllerBase
    {
        ...
        public async Task<ActionResult<ApiResponse<IEnumerable<ProjectTaskResponseDto>>>> GetAllProjectTasks()
        {
            ...
            {
                return StatusCode(500, ApiResponse<IEnumerable<ProjectTaskResponseDto>>.ErrorResponse($"An error occurred while retrieving project tasks: {ex.Message}"));
            }
        }
        ...
        public async Task<ActionResult<ApiResponse<ProjectTaskResponseDto>>> GetProjectTaskById(int id)
        {
            ...
            {
                return StatusCode(500, ApiResponse<ProjectTaskResponseDto>.ErrorResponse($"An error occurred while retrieving project task: {ex.Message}"));
            }
        }
        ...
        public async Task<ActionResult<ApiResponse<ProjectTaskResponseDto>>> CreateProjectTask(CreateProjectTaskDto dto)
        {
            ...
            {
                return StatusCode(500, ApiResponse<ProjectTaskResponseDto>.ErrorResponse($"An error occurred while creating project task: {ex.Message}"));
            }
        }
        ...
        public async Task<ActionResult<ApiResponse<ProjectTaskResponseDto>>> UpdateProjectTask(int id, UpdateProjectTaskDto dto)
        {
            ...
            {
                return StatusCode(500, ApiResponse<ProjectTaskResponseDto>.ErrorResponse($"An error occurred while updating project task: {ex.Message}"));
            }
        }
        ...
        public async Task<ActionResult<ApiResponse<object>>> DeleteProjectTask(int id)
        {
            ...
            {
                return StatusCode(500, ApiResponse<object>.ErrorResponse($"An error occurred while deleting project task: {ex.Message}"));
            }
        }
