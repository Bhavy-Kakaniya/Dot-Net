...
namespace StudentProjectManagementSystem.Controllers
{
    ...
    public class DashboardController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetTasksByStatus()
        {
            try
            {
                var result = await _context.ProjectTasks.GroupBy(x => x.ProjectTaskStatus != null ? x.ProjectTaskStatus.TaskStatusName : "Unknown").Select(g => new { TaskStatus = g.Key, TotalTasks = g.Count() }).ToListAsync();
        ...
        public async Task<IActionResult> GetTasksByPriority()
        {
            try
            {
                var result = await _context.ProjectTasks.GroupBy(x => x.ProjectTaskPriority != null ? x.ProjectTaskPriority.TaskPriorityName : "Unknown").Select(g => new { Priority = g.Key, TotalTasks = g.Count() }).OrderByDescending(x => x.TotalTasks).ToListAsync();
        ...
        public async Task<IActionResult> GetFacultyWorkload()
        {
            try
            {
                var result = await _context.ProjectAllocations.GroupBy(x => x.Faculty != null ? x.Faculty.FullName : "Unassigned").Select(g => new { FacultyName = g.Key, TotalProjects = g.Count() }).OrderByDescending(x => x.TotalProjects).ToListAsync();
        ...
        public async Task<IActionResult> GetStudentTaskCount()
        {
            try
            {
                var result = await _context.ProjectTasks.GroupBy(x => (x.ProjectAllocation != null && x.ProjectAllocation.Student != null) ? x.ProjectAllocation.Student.FullName : "Unassigned").Select(g => new { StudentName = g.Key, TotalTasks = g.Count() }).OrderByDescending(x => x.TotalTasks).ToListAsync();
        ...
        public async Task<IActionResult> GetTopStudents()
        {
            try
            {
                var result = await _context.ProjectTasks.Where(x => x.EarnedScore != null && x.ProjectAllocation != null && x.ProjectAllocation.Student != null).GroupBy(x => x.ProjectAllocation!.Student!.FullName).Select(g => new { StudentName = g.Key, AverageScore = g.Average(x => x.EarnedScore) }).OrderByDescending(x => x.AverageScore).Take(10).ToListAsync();
        ...
        public async Task<IActionResult> GetBottomStudents()
        {
            try
            {
                var result = await _context.ProjectTasks.Where(x => x.EarnedScore != null && x.ProjectAllocation != null && x.ProjectAllocation.Student != null).GroupBy(x => x.ProjectAllocation!.Student!.FullName).Select(g => new { StudentName = g.Key, AverageScore = g.Average(x => x.EarnedScore) }).OrderBy(x => x.AverageScore).Take(10).ToListAsync();
        ...
        public async Task<IActionResult> GetOverdueTasks()
        {
            try
            {
                var result = await _context.ProjectTasks.Where(x => x.TaskDueDate != null && x.TaskDueDate < DateTime.Now && (x.ProjectTaskStatus == null || x.ProjectTaskStatus.TaskStatusName != "Completed")).Select(x => new { x.TaskId, x.TaskTitle, Student = (x.ProjectAllocation != null && x.ProjectAllocation.Student != null) ? x.ProjectAllocation.Student.FullName : "Unassigned", Faculty = (x.ProjectAllocation != null && x.ProjectAllocation.Faculty != null) ? x.ProjectAllocation.Faculty.FullName : "Unassigned", x.TaskDueDate, Status = x.ProjectTaskStatus != null ? x.ProjectTaskStatus.TaskStatusName : "Pending" }).OrderBy(x => x.TaskDueDate).ToListAsync();
        ...
        public async Task<IActionResult> GetProjectDetails()
        {
            try
            {
                var result = await _context.ProjectAllocations.Select(x => new { Project = x.Project != null ? x.Project.ProjectTitle : "N/A", Student = x.Student != null ? x.Student.FullName : "Unassigned", Faculty = x.Faculty != null ? x.Faculty.FullName : "Unassigned", x.ProjectStartDate, x.ProjectEndDate, x.ProgressPercentage }).ToListAsync();
        ...
        public async Task<IActionResult> GetLowProgressProjects()
        {
            try
            {
                var result = await _context.ProjectAllocations.Where(x => x.ProgressPercentage < 50).Select(x => new { Project = x.Project != null ? x.Project.ProjectTitle : "N/A", Student = x.Student != null ? x.Student.FullName : "Unassigned", Faculty = x.Faculty != null ? x.Faculty.FullName : "Unassigned", x.ProgressPercentage }).OrderBy(x => x.ProgressPercentage).ToListAsync();
        ...
        public async Task<IActionResult> GetRoleWiseActiveUsers()
        {
            try
            {
                var result = await _context.UserRoles.Where(x => x.User != null && x.User.IsActive).GroupBy(x => x.Role != null ? x.Role.RoleName : "Unknown").Select(g => new { RoleName = g.Key, ActiveUsers = g.Count() }).OrderByDescending(x => x.ActiveUsers).ToListAsync();
        ...
        public async Task<IActionResult> GetRoleUsers()
        {
            try
            {
                var result = await _context.UserRoles.GroupBy(x => x.Role != null ? x.Role.RoleName : "Unknown").Select(g => new { RoleName = g.Key, Users = g.Select(x => x.User != null ? x.User.FullName : "Unknown").ToList() }).ToListAsync();
        ...
        public async Task<IActionResult> GetRolesMoreThan10Users()
        {
            try
            {
                var result = await _context.UserRoles.GroupBy(x => x.Role != null ? x.Role.RoleName : "Unknown").Select(g => new { RoleName = g.Key, TotalUsers = g.Count() }).Where(x => x.TotalUsers > 10).ToListAsync();
        ...
        public async Task<IActionResult> GetRoleStatistics()
        {
            try
            {
                var result = await _context.UserRoles.GroupBy(x => x.Role != null ? x.Role.RoleName : "Unknown").Select(g => new { RoleName = g.Key, TotalUsers = g.Count(), ActiveUsers = g.Count(x => x.User != null && x.User.IsActive), InactiveUsers = g.Count(x => x.User == null || !x.User.IsActive) }).OrderByDescending(x => x.TotalUsers).ToListAsync();
        ...
        public async Task<IActionResult> GetTasksDueNext7Days()
        {
            try
            {
                ...
                var result = await _context.ProjectTasks.Where(x => x.TaskDueDate != null && x.TaskDueDate >= today && x.TaskDueDate <= nextSevenDays && (x.ProjectTaskStatus == null || x.ProjectTaskStatus.TaskStatusName != "Completed")).Select(x => new { x.TaskId, x.TaskTitle, Student = (x.ProjectAllocation != null && x.ProjectAllocation.Student != null) ? x.ProjectAllocation.Student.FullName : "Unassigned", Faculty = (x.ProjectAllocation != null && x.ProjectAllocation.Faculty != null) ? x.ProjectAllocation.Faculty.FullName : "Unassigned", x.TaskDueDate, Status = x.ProjectTaskStatus != null ? x.ProjectTaskStatus.TaskStatusName : "Pending" }).OrderBy(x => x.TaskDueDate).ToListAsync();
        ...
        public async Task<IActionResult> GetTopProjectsByProgress()
        {
            try
            {
                var result = await _context.ProjectAllocations.Select(x => new { Project = x.Project != null ? x.Project.ProjectTitle : "N/A", Student = x.Student != null ? x.Student.FullName : "Unassigned", Faculty = x.Faculty != null ? x.Faculty.FullName : "Unassigned", x.ProgressPercentage }).OrderByDescending(x => x.ProgressPercentage).Take(10).ToListAsync();
        ...
        public async Task<IActionResult> GetProjectsWithZeroCompletedTasks()
        {
            try
            {
                var result = await _context.ProjectAllocations.Where(x => x.TotalCompletedTasks == 0).Select(x => new { Project = x.Project != null ? x.Project.ProjectTitle : "N/A", Student = x.Student != null ? x.Student.FullName : "Unassigned", Faculty = x.Faculty != null ? x.Faculty.FullName : "Unassigned", x.TotalTasksGiven, x.TotalCompletedTasks, x.ProgressPercentage }).ToListAsync();
        ...
        public async Task<IActionResult> GetAverageProjectProgress()
        {
            try
            {
                var result = await _context.ProjectAllocations.AverageAsync(x => x.ProgressPercentage);
                return Ok(ApiResponse<object>.SuccessResponse("Average project progress retrieved successfully", new { AverageProgress = result }));
            }
            catch (Exception ex)
            {
                return StatusCode(500, ApiResponse<object>.ErrorResponse($"Error: {ex.Message}"));
        ...
        public async Task<IActionResult> GetFacultyAverageProgress()
        {
            try
            {
                var result = await _context.ProjectAllocations.GroupBy(x => x.Faculty != null ? x.Faculty.FullName : "Unassigned").Select(g => new { FacultyName = g.Key, AverageProgress = g.Average(x => x.ProgressPercentage), TotalProjects = g.Count() }).OrderByDescending(x => x.AverageProgress).ToListAsync();
        ...
        public async Task<IActionResult> GetProjectsEndingNext30Days()
        {
            try
            {
                ...
                var result = await _context.ProjectAllocations.Where(x => x.ProjectEndDate >= today && x.ProjectEndDate <= nextThirtyDays).Select(x => new { Project = x.Project != null ? x.Project.ProjectTitle : "N/A", Student = x.Student != null ? x.Student.FullName : "Unassigned", Faculty = x.Faculty != null ? x.Faculty.FullName : "Unassigned", x.ProjectEndDate, x.ProgressPercentage }).OrderBy(x => x.ProjectEndDate).ToListAsync();
        ...
        public async Task<IActionResult> GetTasksByStatusAndPriority()
        {
            try
            {
                var result = await _context.ProjectTasks.GroupBy(x => new { Status = x.ProjectTaskStatus != null ? x.ProjectTaskStatus.TaskStatusName : "Unknown", Priority = x.ProjectTaskPriority != null ? x.ProjectTaskPriority.TaskPriorityName : "Unknown" }).Select(g => new { g.Key.Status, g.Key.Priority, TotalTasks = g.Count() }).OrderBy(x => x.Status).ThenBy(x => x.Priority).ToListAsync();
        ...
        public async Task<IActionResult> GetFacultyTaskStatistics()
        {
            try
            {
                var result = await _context.ProjectTasks.GroupBy(x => (x.ProjectAllocation != null && x.ProjectAllocation.Faculty != null) ? x.ProjectAllocation.Faculty.FullName : "Unassigned").Select(g => new { FacultyName = g.Key, TotalTasks = g.Count(), CompletedTasks = g.Count(x => x.ProjectTaskStatus != null && x.ProjectTaskStatus.TaskStatusName == "Completed"), PendingTasks = g.Count(x => x.ProjectTaskStatus == null || x.ProjectTaskStatus.TaskStatusName != "Completed"), AverageProgress = g.Average(x => x.ProgressPercentage) }).OrderByDescending(x => x.TotalTasks).ToListAsync();
        ...
        public async Task<IActionResult> GetStudentTaskStatistics()
        {
            try
            {
                var result = await _context.ProjectTasks.GroupBy(x => (x.ProjectAllocation != null && x.ProjectAllocation.Student != null) ? x.ProjectAllocation.Student.FullName : "Unassigned").Select(g => new { StudentName = g.Key, TotalTasks = g.Count(), CompletedTasks = g.Count(x => x.ProjectTaskStatus != null && x.ProjectTaskStatus.TaskStatusName == "Completed"), PendingTasks = g.Count(x => x.ProjectTaskStatus == null || x.ProjectTaskStatus.TaskStatusName != "Completed"), AverageProgress = g.Average(x => x.ProgressPercentage), AverageEarnedScore = g.Where(x => x.EarnedScore != null).Average(x => x.EarnedScore) }).OrderByDescending(x => x.AverageProgress).ToListAsync();
        ...
        public async Task<IActionResult> GetProjectsWithAllTasksCompleted()
        {
            try
            {
                ...
                return Ok(ApiResponse<object>.SuccessResponse("Projects with all tasks completed retrieved successfully", result));
            }
            catch (Exception ex)
            {
                return StatusCode(500, ApiResponse<object>.ErrorResponse($"Error: {ex.Message}"));
        ...
        public async Task<IActionResult> GetDashboardSummary()
        {
            try
            {
                ...
                var completedTasks = await _context.ProjectTasks.CountAsync(x => x.ProjectTaskStatus != null && x.ProjectTaskStatus.TaskStatusName == "Completed");
                var pendingTasks = await _context.ProjectTasks.CountAsync(x => x.ProjectTaskStatus == null || x.ProjectTaskStatus.TaskStatusName != "Completed");
